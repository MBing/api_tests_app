# Simple slider and profile navigation page in React

To get started, create a token at:

[Github Developer API](https://developer.github.com/v3/?)
[Unsplash Developers](https://unsplash.com/developers)

Add the tokens/keys to the obvious variables in the file `src/tokens/index.js`
